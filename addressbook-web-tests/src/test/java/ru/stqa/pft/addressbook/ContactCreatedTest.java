...
public class ContactCreatedTest {
  ...
  public void testContactCreated() throws Exception {
    gotoContactPage();
    fillContactForm(new ContactData("Jonson", "Test1", "Broun", "Fred", "NY", "912345678", "876543211", "test@test.com"));
  ...
  private void fillContactForm(ContactData contactData) {
    ...
    wd.findElement(By.name("middlename")).sendKeys(contactData.getMidddlename());
